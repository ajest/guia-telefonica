    ...
    <tr key={key}>
      ...
      <td>
        <BlankLink
          ...
          icon={faSearch}
          storeKey={`${type}-${paginasBlancasZone}-${surname}-${externalSiteKeys['paginas-blancas']}`}
        />
      </td>
      {type === 'province' && <td>
        <BlankLink
          ...
          icon={faSearch}
          storeKey={`${type}-${paginasBlancasZone}-${surname}-${externalSiteKeys['abc-telefonos']}`}
        />
      </td>}
      <td>
        <form action="https://www.telexplorer.com.ar/abogados" method="post" target='_blank'>
          ...
          <SubmitAsALinkButton
            icon={faSearch}
            storeKey={`${type}-${paginasBlancasZone}-${surname}-${externalSiteKeys.telexplorer}`}
          />
        </form>
      </td>
      {type === 'province' && <td>
        <BlankLink
          ...
          icon={faSearch}
          storeKey={`${type}-${paginasBlancasZone}-${surname}-${externalSiteKeys['google-maps']}`}
        />
      </td>}
    </tr>
  )
